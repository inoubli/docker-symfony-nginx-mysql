...
class BlogPost
{
    ...
    /**
     * @Type("ArrayCollection<JMS\Serializer\tests\Fixtures\Comment>")
    ...
    /**
     * @Type("array<JMS\Serializer\tests\Fixtures\Comment>")
    ...
    /**
     * @Type("JMS\Serializer\tests\Fixtures\Publisher")
     */
    private $publisher;

    /**
     * @Type("array<JMS\Serializer\tests\Fixtures\Tag>")
